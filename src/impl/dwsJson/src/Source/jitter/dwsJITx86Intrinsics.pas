...
type
   ...
   Tx86BaseWriteOnlyStream = class(TWriteOnlyBlockStream)
      ...
      public
         ...
         procedure _xmm_reg_reg(op : TxmmOp; dest, src : TxmmRegister); overload;
         procedure _xmm_reg_reg(op : TxmmOp_ss; dest, src : TxmmRegister); overload;
   end;
   ...
   Tx86_64_WriteOnlyStream = class(Tx86BaseWriteOnlyStream)
      ...
      protected
         ...
         procedure _modRMSIB_ptr_reg8_indexed(rm : Integer; base, index : Integer; scale, offset : Integer);

         procedure _vex_m2_modRMSIB_reg_ptr_reg(opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer);
         procedure _vex_m2_modRMSIB_reg_ptr_indexed(opCode : Byte; dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer);

         procedure _vex_ps_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TxmmRegister); overload;
         procedure _vex_ps_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TymmRegister); overload;
         ...
         procedure _vex_d_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TymmRegister); overload;

         procedure _vex_dq_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TymmRegister; with4th : Boolean = False; useW1 : Boolean = False); overload;
         ...
         procedure _vex_d_modRMSIB_reg_ptr_reg(const opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer);
         procedure _vex_dq_modRMSIB_reg_ptr_reg(const opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer; useW1 : Boolean = False);
         procedure _vex_dqu_modRMSIB_reg_ptr_reg(const opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer);

         procedure _vex_m3_modRMSIB_reg_ptr_reg_imm(opCode : Byte; reg : TxmmRegister; dest : TgpRegister64; offset : Integer; imm : Byte);

         procedure _vex_ps_modRMSIB_reg_ptr_indexed(const opCode : Byte; dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
         ...
         procedure _vex_dq_modRMSIB_reg_ptr_indexed(const opCode : Byte; dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer; useW1 : Boolean = False);
      ...
      public
         ...
         procedure _movq_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);

         procedure _movlps_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
         procedure _movhps_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
         ...
         procedure _movups_reg_ptr_reg_reg(dest : TxmmRegister; src1, src2 : TgpRegister64);
         procedure _movups_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);

         procedure _movntps_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
         procedure _movdqu_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);

         procedure _xmm_reg_qword_ptr_reg(op : TxmmOp; reg : TxmmRegister; src : TgpRegister64; offset : Integer);
         procedure _xmm_reg_dword_ptr_reg(op : TxmmOp_ss; reg : TxmmRegister; src : TgpRegister64; offset : Integer);
         procedure _xmm_reg_execmem(op : TxmmOp; reg : TxmmRegister; stackAddr : Integer);
         procedure _xmm_reg_absmem(op : TxmmOp; reg : TxmmRegister; ptr : Pointer);

         procedure _xmm_pd_reg_reg(op : TxmmOp_pd; dest, src : TxmmRegister);
         procedure _xmm_ps_reg_reg(op : TxmmOp_ps; dest, src : TxmmRegister);

         procedure _comiss_reg_reg(dest, src : TxmmRegister);
         procedure _comisd_reg_reg(dest, src : TxmmRegister);
         procedure _comisd_reg_execmem(reg : TxmmRegister; stackAddr : Integer);
         procedure _comisd_reg_absmem(reg : TxmmRegister;  ptr : Pointer);
         ...
         procedure _vcmpps(dest, src1, src2 : TymmRegister; predicate : Byte);
         procedure _vcmppd(dest, src1, src2 : TymmRegister; predicate : Byte);
         procedure _vpcmpeqd(dest, src1, src2 : TymmRegister);
         procedure _vpcmpeqq(dest, src1, src2 : TymmRegister);

         procedure _vpblendvb(dest, src1, src2, src3 : TymmRegister);
         procedure _vblendvps(dest, src1, src2, src3 : TymmRegister);
         procedure _vblendvpd(dest, src1, src2, src3 : TymmRegister);

         procedure _vbroadcastss(dest: TymmRegister; src : TxmmRegister);
         procedure _vbroadcastss_ptr_reg(dest: TymmRegister; src : TgpRegister64; offset : Integer);
         procedure _vbroadcastss_ptr_indexed(dest: TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
         ...
         procedure _vbroadcastsd_ptr_indexed(dest: TymmRegister; base, index : TgpRegister64; scale, offset : Integer);

         procedure _vpbroadcastd_ptr_reg(dest: TymmRegister; src : TgpRegister64; offset : Integer);
         ...
         procedure _vsubps(dest, src1, src2 : TxmmRegister); overload;
         procedure _vsubps(dest, src1, src2 : TymmRegister); overload;
         ...
         procedure _vdivps(dest, src1, src2 : TxmmRegister); overload;
         procedure _vdivps(dest, src1, src2 : TymmRegister); overload;

         procedure _vmulsd(dest, src1, src2 : TxmmRegister); overload;

         procedure _vmaxps(dest, src1, src2 : TxmmRegister); overload;
         procedure _vmaxps(dest, src1, src2 : TymmRegister); overload;
         ...
         procedure _vmovaps(dest, src : TymmRegister); overload;
         ...
         procedure _vmovups_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TymmRegister); overload;
         procedure _vmovups_ptr_indexed(dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
         procedure _vextractps_ptr_reg_imm(dest : TgpRegister64; offset : Integer; src : TxmmRegister; imm8 : Byte);
         ...
         procedure _vmovupd_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer); overload;
         ...
         procedure _vmovupd_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TymmRegister); overload;
         procedure _vmovupd_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister); overload;
         ...
         procedure _vmovsd_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
         procedure _vmovsd_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
         ...
         procedure _vfmadd231pd_ptr_reg(dest, src1 : TxmmRegister; src2 : TgpRegister64; offset : Int32); overload;
         procedure _vfmadd231pd_ptr_reg(dest, src1 : TymmRegister; src2 : TgpRegister64; offset : Int32); overload;
         procedure _vfmadd231sd_ptr_reg(dest, src1 : TxmmRegister; src2 : TgpRegister64; offset : Int32); overload;
...
// _xmm_reg_reg
//
procedure Tx86BaseWriteOnlyStream._xmm_reg_reg(op : TxmmOp_ss; dest, src : TxmmRegister);
begin
   WriteByte($F3);
   _modRMSIB_reg_reg([$0F, Ord(op)], dest, src);
end;
...
// _modRMSIB_ptr_reg8_indexed
//
procedure Tx86_64_WriteOnlyStream._modRMSIB_ptr_reg8_indexed(rm : Integer; base, index : Integer; scale, offset : Integer);
var
   sib : Integer;
begin
   Assert(scale in [1, 2, 4, 8]);
   ...
   if (index=Ord(gprESP)) and (base<>Ord(gprESP)) then begin
      Assert(scale=1);
      _modRMSIB_ptr_reg8_indexed(rm, index, base, 1, offset);
   end;
...
begin
   if src2 > xmm7 then begin
      ...
      WriteBytes([
         $c5,
         $f8 - Ord(Ord(dest) >= 8)*$80 - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7) * 8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end;
...
// _vex_ps_modRMSIB_reg_reg
//
procedure Tx86_64_WriteOnlyStream._vex_ps_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TymmRegister);
begin
   if src2 > ymm7 then begin
      WriteBytes([
         $c4,
         $c1 - Ord(Ord(dest) >= 8)*$80,
         $7c - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7)*8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end else begin
      WriteBytes([
         $c5,
         $fc - Ord(Ord(dest) >= 8)*$80 - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7) * 8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end;
...
begin
   if src2 > xmm7 then begin
      WriteBytes([
         $c4,
         $c1 - Ord(Ord(dest) >= 8)*$80,
         $7a - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7)*8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end else begin
      WriteBytes([
         $c5,
         $fa - Ord(Ord(dest) >= 8)*$80 - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7) * 8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end;
...
begin
   if src2 > xmm7 then begin
      WriteBytes([
         $c4,
         $c1 - Ord(Ord(dest) >= 8)*$80,
         $7b - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7)*8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end else begin
      WriteBytes([
         $c5,
         $fb - Ord(Ord(dest) >= 8)*$80 - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7) * 8,
         opCode,
         $c0 + (Ord(src2) and 7) + (Ord(dest) and 7)*8
      ]);
   end;
...
// _vex_d_modRMSIB_reg_reg
//
procedure Tx86_64_WriteOnlyStream._vex_d_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TymmRegister);
begin
   if src2 > ymm7 then
      WriteBytes([
         $c4,
      ...
      WriteBytes([
         $c5,
         $fd - Ord(Ord(dest) >= 8)*$80 - Ord(src1)*8
         ]);
...
//
procedure Tx86_64_WriteOnlyStream._vex_dq_modRMSIB_reg_reg(const opCode : Byte; dest, src1, src2 : TymmRegister; with4th : Boolean = False; useW1 : Boolean = False);
begin
   WriteBytes([
      $c4,
      $e2 - Ord(Ord(dest) >= 8)*$80 - Ord(Ord(src2) >= 8)*$20 + Ord(with4th),
      $7d - Ord(Ord(src1) >= 8)*$40 - (Ord(src1) and 7)*8 + Ord(useW1)*$80
   ]);
   _modRMSIB_reg8_reg8(opCode, Ord(dest) and 7, Ord(src2) and 7);
end;
...
begin
   if src2 < gprR8 then
      WriteBytes([$c5, $fc - Ord(dest > ymm7)*$80 - Ord(src1 > ymm7)*$40 - (Ord(src1) and 7)*8, opCode])
   else WriteBytes([$c4, $c1 - Ord(dest > ymm7)*$80, $7c - Ord(src1 > ymm7)*$40 - (Ord(src1) and 7)*8, opCode]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src2) and 7, offset);
end;
...
begin
   if src2 < gprR8 then
      WriteBytes([$c5, $f8 - Ord(dest > xmm7)*$80 - Ord(src1 > xmm7)*$40 - (Ord(src1) and 7)*8, opCode])
   else WriteBytes([$c4, $c1 - Ord(dest > xmm7)*$80, $78 - Ord(src1 > xmm7)*$40 - (Ord(src1) and 7)*8, opCode]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src2) and 7, offset);
end;
...
begin
   if src < gprR8 then
      WriteBytes([$c5, $fc - $80*Ord(dest >= ymm8), opCode])
   else WriteBytes([$c4, $c1 - $80*Ord(dest >= ymm8), $7c, opCode]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src) and 7, offset);
end;
...
begin
   ...
   else WriteBytes([$c4, $c1 - $80*Ord(dest >= ymm8), $7d, opCode]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src) and 7, offset);
end;

// _vex_d_modRMSIB_reg_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._vex_d_modRMSIB_reg_ptr_reg(const opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer);
begin
   WriteBytes([
      $c4,
...
//
procedure Tx86_64_WriteOnlyStream._vex_dq_modRMSIB_reg_ptr_reg(const opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer; useW1 : Boolean = False);
begin
   WriteBytes([
      $c4,
      $e2 - Ord(Ord(dest) >= 8)*$80 - Ord(src >= gprR8)*$20,
...
begin
   if src < gprR8 then
      WriteBytes([$c5, $fe - $80*Ord(dest >= ymm8), opCode])
   else WriteBytes([$c4, $c1 - $80*Ord(dest >= ymm8), $7e, opCode]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7)*8, Ord(src) and 7, offset);
end;

// _vex_ps_modRMSIB_reg_ptr_indexed
//
procedure Tx86_64_WriteOnlyStream._vex_ps_modRMSIB_reg_ptr_indexed(const opCode : Byte; dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
begin
   WriteBytes([
      $c4,
      $e1 - Ord(dest >= ymm8)*$80 - Ord(index >= gprR8)*$40 - Ord(base >= gprR8)*$20,
      $7c,
      opCode
   ]);
   _modRMSIB_ptr_reg8_indexed((Ord(dest) and 7)*8, Ord(base) and 7, Ord(index) and 7, scale, offset);
end;
...
//
procedure Tx86_64_WriteOnlyStream._vex_dq_modRMSIB_reg_ptr_indexed(const opCode : Byte; dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer; useW1 : Boolean = False);
begin
   WriteBytes([
      $c4,
      $e2 - Ord(dest >= ymm8)*$80 - Ord(index >= gprR8)*$40 - Ord(base >= gprR8)*$20,
      $7d + Ord(useW1)*$80,
      opCode
   ]);
   _modRMSIB_ptr_reg8_indexed((Ord(dest) and 7)*8, Ord(base) and 7, Ord(index) and 7, scale, offset);
...
begin
   ...
   _modRMSIB_ptr_reg8_indexed((Ord(src) and 7)*8, Ord(base) and 7, Ord(index) and 7, scale, offset);
end;
...
// _movq_reg_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._movq_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
begin
   WriteByte($f3);
   if dest > xmm7 then
      WriteByte($44);
   _modRMSIB_regnum_ptr_reg([], [$0F, $7E], Ord(dest) and 7, src, offset);
end;

// _movlps_reg_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._movlps_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
begin
   if dest > xmm7 then
      WriteByte($44);
   _modRMSIB_regnum_ptr_reg([], [$0F, $12], Ord(dest) and 7, src, offset);
end;

// _movhps_reg_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._movhps_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
begin
   if dest > xmm7 then
      WriteByte($44);
   _modRMSIB_regnum_ptr_reg([], [$0F, $16], Ord(dest) and 7, src, offset);
end;
...
// _movups_reg_ptr_reg_reg
//
procedure Tx86_64_WriteOnlyStream._movups_reg_ptr_reg_reg(dest : TxmmRegister; src1, src2 : TgpRegister64);
begin
   if dest >= xmm8 then
      WriteByte($44);
   if (src1 >= gprR8) or (src2 >= gprR8) then
      WriteByte($40 + Ord(src1 >= gprR8) + 2*Ord(src2 >= gprR8));
   WriteBytes([$0F, $10, $04 + 8 * (Ord(dest) and 7), (Ord(src1) and 7) + 8 * (Ord(src2) and 7)]);
end;

// _movups_ptr_reg_reg
//
procedure Tx86_64_WriteOnlyStream._movups_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
begin
   if src > xmm7 then
      WriteByte($44);
   _modRMSIB_regnum_ptr_reg([], [$0F, $11], Ord(src) and 7, dest, offset);
end;

// _movntps_ptr_reg_reg
//
procedure Tx86_64_WriteOnlyStream._movntps_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
begin
   if src > xmm7 then
      WriteByte($44);
   _modRMSIB_regnum_ptr_reg([], [$0F, $2b], Ord(src) and 7, dest, offset);
end;

// _movdqu_ptr_reg_reg
//
procedure Tx86_64_WriteOnlyStream._movdqu_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
begin
   WriteByte($f3);
   if src > xmm7 then
      WriteByte($44);
   _modRMSIB_regnum_ptr_reg([], [$0F, $7F], Ord(src) and 7, dest, offset);
end;
...
//
procedure Tx86_64_WriteOnlyStream._xmm_reg_dword_ptr_reg(op : TxmmOp_ss; reg : TxmmRegister; src : TgpRegister64; offset : Integer);
begin
   Assert(reg in [xmm0..High(TxmmRegister)]);

   if (reg < xmm8) and (src < gprR8) then
      _modRMSIB_regnum_ptr_reg([$F3], [$0F, Ord(op)], Ord(reg), src, offset)
   else _modRMSIB_regnum_ptr_reg([$F3], [$0F, Ord(op)],
                                 Ord(reg), src, offset);
end;
...
begin
   _xmm_reg_qword_ptr_reg(op, reg, cExecMemGPR, StackAddrToOffset(stackAddr));
end;
...
begin
   _mov_reg_qword(gprRAX, QWORD(ptr));
   _xmm_reg_qword_ptr_reg(op, reg, gprRAX, 0);
end;
...
// _xmm_ps_reg_reg
//
procedure Tx86_64_WriteOnlyStream._xmm_ps_reg_reg(op : TxmmOp_ps; dest, src : TxmmRegister);
begin
   _modRMSIB_reg_reg([$0F, Ord(op)], dest, src);
end;
...
// _comiss_reg_reg
//
procedure Tx86_64_WriteOnlyStream._comiss_reg_reg(dest, src : TxmmRegister);
begin
   if (dest >= xmm8) or (src >= xmm8) then
      WriteByte($40 + Ord(src >= xmm8) + 4*Ord(dest >= xmm8));
   WriteBytes([
...
// _vmovaps
//
procedure Tx86_64_WriteOnlyStream._vmovaps(dest, src : TymmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($28, dest, ymm0, src);
end;
...
begin
   if dest < gprR8 then
      WriteBytes([$c5, $fa - Ord(src > xmm7)*$80, $11])
   else WriteBytes([$c4, $c1 - Ord(src > xmm7)*$80, $7a, $11]);
   _modRMSIB_ptr_reg8((Ord(src) and 7) shl 3, Ord(dest) and 7, offset);
end;
...
// _vmovsd_ptr_reg_reg
//
procedure Tx86_64_WriteOnlyStream._vmovsd_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
begin
   if dest < gprR8 then
      WriteBytes([$c5, $fb - Ord(src > xmm7)*$80, $11])
   else WriteBytes([$c4, $c1 - Ord(src > xmm7)*$80, $7b, $11]);
   _modRMSIB_ptr_reg8((Ord(src) and 7)*8, Ord(dest) and 7, offset);
end;

// _vmovsd_reg_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._vmovsd_reg_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
begin
   if src < gprR8 then
      WriteBytes([$c5, $fb - Ord(dest > xmm7)*$80, $10])
   else WriteBytes([$c4, $c1 - Ord(dest > xmm7)*$80, $7b, $10]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7)*8, Ord(src) and 7, offset);
end;
...
begin
   if src < gprR8 then
      WriteBytes([$c5, $f8 - Ord(dest > xmm7)*$80, $10])
   else WriteBytes([$c4, $c1 - Ord(dest > xmm7)*$80, $78, $10]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src) and 7, offset);
end;
...
begin
   if dest < gprR8 then
      WriteBytes([$c5, $f8 - Ord(src > xmm7)*$80, $11])
   else WriteBytes([$c4, $c1 - Ord(src > xmm7)*$80, $78, $11]);
   _modRMSIB_ptr_reg8((Ord(src) and 7) shl 3, Ord(dest) and 7, offset);
end;

procedure Tx86_64_WriteOnlyStream._vmovups_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TymmRegister);
begin
...
procedure Tx86_64_WriteOnlyStream._vex_m3_modRMSIB_reg_ptr_reg_imm(opCode : Byte; reg : TxmmRegister; dest : TgpRegister64; offset : Integer; imm : Byte);
begin
   WriteBytes([
      $c4,
      $e3 - Ord(reg >= xmm8)*$80 - Ord(dest >= gprR8)*$20,
      $79,
      opCode
   ]);
   _modRMSIB_ptr_reg8((Ord(reg) and 7) shl 3, Ord(dest) and 7, offset);
   WriteByte(imm);
end;

// _vextractps_ptr_reg_imm
//
procedure Tx86_64_WriteOnlyStream._vextractps_ptr_reg_imm(dest : TgpRegister64; offset : Integer; src : TxmmRegister; imm8 : Byte);
begin
   _vex_m3_modRMSIB_reg_ptr_reg_imm($17, src, dest, offset, imm8);
end;
...
procedure Tx86_64_WriteOnlyStream._vmovupd_ptr_reg(dest : TxmmRegister; src : TgpRegister64; offset : Integer);
begin
   _vex_pd_modRMSIB_reg_ptr_reg($10, TymmRegister(dest), src, offset);
end;
...
procedure Tx86_64_WriteOnlyStream._vmovupd_ptr_reg_reg(dest : TgpRegister64; offset : Integer; src : TxmmRegister);
begin
   if dest < gprR8 then begin
      WriteBytes([
         $c5,
...
// _v_op_ps
//
procedure Tx86_64_WriteOnlyStream._v_op_ps(op : TxmmOp_ps; dest, src1, src2 : TymmRegister);
begin
   _vex_ps_modRMSIB_reg_reg(Ord(op), dest, src1, src2);
end;
...
// _vcmpps
//
procedure Tx86_64_WriteOnlyStream._vcmpps(dest, src1, src2 : TymmRegister; predicate : Byte);
begin
   _vex_ps_modRMSIB_reg_reg($C2, dest, src1, src2);
   WriteByte(predicate);
end;
...
// _vpcmpeqd
//
procedure Tx86_64_WriteOnlyStream._vpcmpeqd(dest, src1, src2 : TymmRegister);
begin
   _vex_d_modRMSIB_reg_reg($76, dest, src1, src2);
end;
...
// _vblendvps
//
procedure Tx86_64_WriteOnlyStream._vblendvps(dest, src1, src2, src3 : TymmRegister);
begin
   _vex_dq_modRMSIB_reg_reg($4A, dest, src1, src2, True);
   WriteByte(Ord(src3) shl 4);
end;
...
procedure Tx86_64_WriteOnlyStream._vex_m2_modRMSIB_reg_ptr_reg(opCode : Byte; dest : TymmRegister; src : TgpRegister64; offset : Integer);
begin
   WriteBytes([
      $c4,
      $e2 - Ord(dest >= ymm8)*$80 - Ord(src >= gprR8)*$20,
      $7d,
      opCode
   ]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src) and 7, offset);
...
procedure Tx86_64_WriteOnlyStream._vex_m2_modRMSIB_reg_ptr_indexed(opCode : Byte; dest : TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
begin
   WriteBytes([
      $c4,
      $e2 - Ord(dest >= ymm8)*$80 - Ord(index >= gprR8)*$40 - Ord(base >= gprR8)*$20,
   ...
   _modRMSIB_ptr_reg8_indexed((Ord(dest) and 7) shl 3, Ord(base) and 7, Ord(index) and 7, scale, offset);
end;

// _vbroadcastss
//
procedure Tx86_64_WriteOnlyStream._vbroadcastss(dest: TymmRegister; src : TxmmRegister);
begin
   _vex_dq_modRMSIB_reg_reg($18, dest, ymm0, TymmRegister(src));
end;

// _vbroadcastss_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._vbroadcastss_ptr_reg(dest: TymmRegister; src : TgpRegister64; offset : Integer);
begin
   _vex_m2_modRMSIB_reg_ptr_reg($18, dest, src, offset);
end;

procedure Tx86_64_WriteOnlyStream._vbroadcastss_ptr_indexed(dest: TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
begin
   _vex_m2_modRMSIB_reg_ptr_indexed($18, dest, base, index, scale, offset);
end;
...
// _vbroadcastsd_ptr_indexed
//
procedure Tx86_64_WriteOnlyStream._vbroadcastsd_ptr_indexed(dest: TymmRegister; base, index : TgpRegister64; scale, offset : Integer);
begin
   _vex_dq_modRMSIB_reg_ptr_indexed($19, dest, base, index, scale, offset);
end;

// _vpbroadcastd_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._vpbroadcastd_ptr_reg(dest: TymmRegister; src : TgpRegister64; offset : Integer);
begin
   _vex_dq_modRMSIB_reg_ptr_reg($58, dest, src, offset);
end;
...
begin
   _vex_ps_modRMSIB_reg_reg($57, dest, src1, src2);
end;
...
// _vsubps
//
procedure Tx86_64_WriteOnlyStream._vsubps(dest, src1, src2 : TxmmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($5C, dest, src1, src2);
end;

procedure Tx86_64_WriteOnlyStream._vsubps(dest, src1, src2 : TymmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($5C, dest, src1, src2);
end;
...
// _vdivps
//
procedure Tx86_64_WriteOnlyStream._vdivps(dest, src1, src2 : TxmmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($5E, dest, src1, src2);
end;

procedure Tx86_64_WriteOnlyStream._vdivps(dest, src1, src2 : TymmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($5E, dest, src1, src2);
end;
...
// _vmaxps
//
procedure Tx86_64_WriteOnlyStream._vmaxps(dest, src1, src2 : TxmmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($5F, dest, src1, src2);
end;

// _vmaxps
//
procedure Tx86_64_WriteOnlyStream._vmaxps(dest, src1, src2 : TymmRegister);
begin
   _vex_ps_modRMSIB_reg_reg($5F, dest, src1, src2);
end;
...
begin
   _vex_sd_modRMSIB_reg_reg($7C, dest, src1, src2);
end;
...
// _vfmadd_ps
//
procedure Tx86_64_WriteOnlyStream._vfmadd_ps(op : Integer; dest, src1, src2 : TxmmRegister);
begin
   case op of
      132 : op := $98;
      213 : op := $A8;
...
// _vfmadd_ps
//
procedure Tx86_64_WriteOnlyStream._vfmadd_ps(op : Integer; dest, src1, src2 : TymmRegister);
begin
   case op of
      132 : op := $98;
      213 : op := $A8;
...
begin
   WriteBytes([
      $c4,
      $e2 - $80*Ord(dest >= xmm8) - $20*Ord(src2 >= gprR8),
...
//
procedure Tx86_64_WriteOnlyStream._vfmadd231pd_ptr_reg(dest, src1 : TxmmRegister; src2 : TgpRegister64; offset : Int32);
begin
   WriteBytes([$c4, $e2 - Ord(dest >= xmm8)*$80 - Ord(src2 >= gprR8)*$20, $f9 - Ord(src1 >= xmm8)*$40 - (Ord(src1) and 7)*8, $b8]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src2) and 7, offset);
end;
...
begin
   WriteBytes([$c4, $e2 - Ord(dest >= ymm8)*$80 - Ord(src2 >= gprR8)*$20, $fd - Ord(src1 >= ymm8)*$40 - (Ord(src1) and 7)*8, $b8]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src2) and 7, offset);
end;

// _vfmadd231sd_ptr_reg
//
procedure Tx86_64_WriteOnlyStream._vfmadd231sd_ptr_reg(dest, src1 : TxmmRegister; src2 : TgpRegister64; offset : Int32);
begin
   WriteBytes([$c4, $e2 - Ord(dest >= xmm8)*$80 - Ord(src2 >= gprR8)*$20, $f9 - Ord(src1 >= xmm8)*$40 - (Ord(src1) and 7)*8, $b9]);
   _modRMSIB_ptr_reg8((Ord(dest) and 7) shl 3, Ord(src2) and 7, offset);
end;
...
begin
   WriteBytes([
      $c4,
      $e2 - Ord(dest >= ymm8)*$80 - $20*Ord(src2 >= gprR8),
